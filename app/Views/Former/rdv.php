...
<div class='container-fluid mt-2'>
    <div class="row">
            ...
            <div class="container mx-0 my-1">
                <form id="rdvForm" >
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating mb-3 col-12  col-md-6">
                            <input class="form-control" id="timeStart" name="timeStart" type="time"
                    ...
                    <div class="row">
                        ...
                        <div class="form-floating mb-3  col-12 col-md-6">
                            <input class="form-control" id="timeEnd" name="timeEnd" type="time"
        ...
        <div class="my-0 ms-4 col-10 col-md-6 ">
