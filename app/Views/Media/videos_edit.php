    ...
    <form action="/admin/videos/edit" method="post">
        <div class="row">
            <div class='form-floating mb-3 col-12 col-md-4'>
                <input class='form-control' id='name' type='text' name='name' placeholder="Nom de la vidéo" />
            ...
            <div class='form-floating mb-3 col-12 col-md-4'>
                <input class='form-control' id='url' type='text' name='url' placeholder="Url de la vidéo"  />
