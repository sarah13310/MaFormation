...
<body>
    <header>
        ...
        <nav class="navbar navbar-expand-lg <?= getTheme($user['type'], "nav") ?>">
            <div class="container-fluid">
                <a id="btn_home" class="noselect navbar-brand"><img class="noselect logo" alt="logo" src="<?= base_url() ?>/assets/logo.svg"> Ma Formation</a>
                    ...
                    <?php else : ?>
                        <div class="noselect dropdown ">
                            <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                                <img alt="image profil" loading="lazy" src="<?= ($user['image_url'] == null) ? constant('DEFAULT_IMG_BLANK') : $user['image_url'] ?>" alt="MF" width="50px" height="50px" class="rounded-circle-frame">
    ...
    <!-- Footer -->
    <footer class=" <?= getTheme($user['type'], "footer") ?> text-center text-white">
        <!-- Grid container -->
