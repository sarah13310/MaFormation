...
class FilterAlpha extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.buttonAlpha.innerHTML = "<i style=\"font-size: 1.4rem;\" class=\"bi bi-x\"></i>"
        ...
        this.buttonAlpha.addEventListener("click", (e) => {
            ...
            this.dispatchEvent(new CustomEvent('onSort',
                {
                    bubbles: true, detail: { value: this.index }
                }));
        })
    }
    ...
    updateButton() {
        switch (this.index) {
            ...
            case 0:
                ...
                break;
            case 1:
                this.buttonAlpha.innerHTML = "<i style=\"font-size: 1.4rem;\" class=\"bi bi-sort-alpha-down\"></i>";
                break;
            case 2:
                this.buttonAlpha.innerHTML = "<i style=\"font-size: 1.4rem;\" class=\"bi bi-sort-alpha-down-alt\"></i>";
                break;
        }
    }
