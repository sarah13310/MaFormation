 ...
 * Original files:
 * - /npm/sceditor@3.1.1/minified/icons/monocons.min.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
/**
 * Skipped minification because the original files appears to be already minified.
 * Original file: /npm/sceditor@3.1.1/minified/icons/monocons.js
 *
 * Do NOT use SRI with dynamically generated files! More information: https://www.jsdelivr.com/using-sri-with-dynamic-files
 */
...
!function (a) {
    ...
    a.icons.monocons = function () {
        ...
        return {
            create: function (h) {
                return h in c && (v[h] = a.dom.parseHTML('<svg xmlns="http://www.w3.org/2000/svg" viewbox="0 0 16 16" unselectable="on">' + c[h] + "</svg>").firstChild, "color" === h && (z = v[h].querySelector(".sce-color"))), v[h]
            }, update: function (h, a) {
                var v;
                z && (v = "inherit", !h && a && (v = a.ownerDocument.queryCommandValue("forecolor")), t.css(z, "fill", v))
            }, rtl: function (h) {
                var a = v.grip;
                a && (h = h ? "scaleX(-1)" : "", t.css(a, "transform", h), t.css(a, "msTransform", h), t.css(a, "webkitTransform", h))
            }
        }
    }, a.icons.monocons.icons = c
}((document, sceditor));
//# sourceMappingURL=/sm/8b6b94d1f442827883a0318877d79d9b257581ffe2da2c0b03a9f7fe204e63ac.map